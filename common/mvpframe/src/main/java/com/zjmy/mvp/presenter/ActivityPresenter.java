...
import com.zjmy.mvp.util.StatusBarUtil;
...
public abstract class ActivityPresenter<V extends IView, M extends IModel> extends FragmentActivity implements IListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.instance().setStatusBar(getContext(), setStatusColor());
    ...
    public abstract int setStatusColor();
